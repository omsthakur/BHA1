...
import { LogOut, Plus, Pencil, Trash2, Users, FolderKanban, FileText, Image, MapPin, Briefcase, Megaphone, Mail, Settings as SettingsIcon, ArrowLeft } from "lucide-react";
      ...
      <Card className="w-full max-w-md border border-slate-200 shadow-lg">
        <CardContent className="p-8">
          <div className="text-center mb-8">
            <img src={LOGO_URL} alt="Texas BHA" className="h-16 w-16 mx-auto rounded-full bg-[#0F172A] p-2" />
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-slate-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-14">
          <div className="flex items-center gap-3">
            <img src={LOGO_URL} alt="Texas BHA" className="h-8 w-8 rounded-full" />
