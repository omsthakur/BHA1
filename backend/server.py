...
async def seed_database():
    ...
    # Chapters
    chapters = [
        Chapter(name="UT Austin Chapter", university="University of Texas at Austin", location="Austin, TX", founding_date="2022-09-01", leadership=["Jordan Lee", "Ashley Martinez"], description="The founding chapter of Texas BHA, leading initiatives in healthcare policy and consulting at UT Austin.", signup_link="#", lat=30.2849, lng=-97.7341),
        Chapter(name="Texas A&M Chapter", university="Texas A&M University", location="College Station, TX", founding_date="2023-01-15", leadership=["Chris Walker", "Samantha Davis"], description="Focused on rural health economics and community outreach in the Brazos Valley region.", signup_link="#", lat=30.6187, lng=-96.3365),
        Chapter(name="Rice University Chapter", university="Rice University", location="Houston, TX", founding_date="2023-04-01", leadership=["Michael Chang", "Laura Bennett"], description="Bridging the Texas Medical Center with business innovation and healthcare entrepreneurship.", signup_link="#", lat=29.7174, lng=-95.4018),
        Chapter(name="Baylor University Chapter", university="Baylor University", location="Waco, TX", founding_date="2023-08-20", leadership=["Daniel Foster", "Emma Wilson"], description="Combining faith-based healthcare values with evidence-based business strategies.", signup_link="#", lat=31.5493, lng=-97.1467),
        Chapter(name="University of Houston Chapter", university="University of Houston", location="Houston, TX", founding_date="2024-01-10", leadership=["Aisha Johnson", "Ryan Patel"], description="Connecting diverse perspectives in one of the nation's most diverse healthcare markets.", signup_link="#", lat=29.7199, lng=-95.3422),
    ]
    for ch in chapters:
